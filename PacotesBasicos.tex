...
% Comando para siglas com hyperlink para a Lista de Siglas
% Uso: \sigla{KEY} produz a sigla clicável que leva para a entrada com \hypertarget{sigla:KEY}{...} na Lista de Siglas
\newcommand{\sigla}[1]{\hyperlink{sigla:#1}{#1}}
