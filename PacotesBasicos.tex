...
% Espaçamento abaixo de equações em modo display, para separar
% visualmente a equação do parágrafo seguinte.
\setlength{\belowdisplayskip}{14pt plus 3pt minus 2pt}
...
% Comando para siglas com expansão automática e Lista de Siglas auto-populada
% Uso: \sigla{KEY} expande "Forma Completa (KEY)" na primeira ocorrência e mostra apenas "KEY" nas seguintes, com hyperlink para a Lista de Siglas.
% As definições KEY -> Forma Completa ficam em PreTextuais/Listas.tex via \acro{KEY}{Forma Completa}.
% Com a opção printonlyused, somente as siglas efetivamente usadas no texto aparecem na Lista.
\usepackage[printonlyused]{acronym}
\newcommand{\sigla}[1]{\ac{#1}}
...
% ---
% Impede a quebra de notas de rodape entre paginas (nota inteira
% permanece na pagina em que foi chamada ou desce completa para a
% seguinte). Evita notas longas (wafer, slivers, pinholes, chevron)
% divididas em duas folhas.
