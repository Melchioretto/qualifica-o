...
%   2.3  Mostra a tradição de apoio à decisão técnica e suas
%        limitações diante de dados sensoriais modernos.
%   2.4  Apresenta a primeira família de técnicas (anomalias
%        em séries operacionais) que sustenta o Pilar EQ. RQ1.
%   2.5  Apresenta a segunda família (estatística histórica por
%        lote, fornecedor, máquina) que sustenta o Pilar MP. RQ3.
%   2.6  Discute a integração das duas famílias e a
