...
O aumento total de diâmetro do fio decorrente das camadas é denominado build. A montagem física da linha é vertical, motivo pelo qual o equipamento é chamado enameling tower. Concluído o build especificado, o fio esmaltado é bobinado em sua apresentação final. Cada uma das etapas apresentadas até aqui, no entanto, pode ser interrompida por rompimentos do fio, evento operacional cujas causas e mecanismos serão examinados a seguir.
