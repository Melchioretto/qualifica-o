...
O cobre passa, ainda nesta linha, por uma etapa de recozimento posterior à trefilação. Essa etapa restaura a ductilidade reduzida pelo trabalho a frio dos múltiplos passes e recupera a condutividade elétrica degradada durante a deformação \cite{wright2011wire}. O alumínio, com resposta de encruamento menos pronunciada sob as mesmas reduções, dispensa essa etapa intermediária \textcolor{red}{[ref: comportamento de encruamento de Al vs Cu — ASM Handbook v. 14A ou Dieter Mechanical Metallurgy]}.
...
O aumento total de diâmetro do fio decorrente das camadas é denominado build, com especificações comerciais classificadas em single, heavy e triple, em ordem crescente de espessura \textcolor{red}{[ref: classificação de build de magnet wire — norma IEC 60317 ou NEMA MW 1000]}. A montagem física da linha é vertical, motivo pelo qual o equipamento é chamado enameling tower \cite{wright2011wire}. Concluído o build especificado, o fio esmaltado é bobinado em sua apresentação final. Cada uma das etapas apresentadas até aqui, no entanto, pode ser interrompida por rompimentos do fio, evento operacional cujas causas e mecanismos serão examinados a seguir.
