...
A direção principal projeta a construção de uma ferramenta visual de apoio ao operador e à equipe técnica, que tomará o método proposto como núcleo de inferência e adicionará camadas de operação em tempo real, alertas acionáveis e integração com os sistemas de chão de fábrica. A passagem do regime retrospectivo, adotado nesta dissertação conforme indicado na Seção~\ref{sec:caracterizacao_pesquisa}, para um regime de inferência continuada exigirá decisões de arquitetura e de integração que extrapolam o escopo do mestrado. O detalhamento dessa ferramenta, incluindo escolhas de interface, tecnologia e fluxo operacional, constitui agenda de trabalho posterior à conclusão do mestrado.
