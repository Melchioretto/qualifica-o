...
\begin{itemize}
    ...
    \item \textbf{ChatGPT (OpenAI), modelo de geração de imagens GPT Image 1} \textcolor{red}{[CONFIRMAR: nome e versão exata do modelo de geração de imagens utilizado]}: composição parcial de elementos de figuras conceituais. Nenhuma figura foi produzida integralmente por modelo de inteligência artificial. Todas as figuras finais foram compostas, editadas e validadas pelo autor.
\end{itemize}
