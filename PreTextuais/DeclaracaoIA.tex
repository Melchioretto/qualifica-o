...
Esta dissertação utilizou ferramentas de inteligência artificial generativa em etapas específicas de apoio à elaboração do texto, das figuras e da revisão sistemática da literatura, sob supervisão, conferência e responsabilidade final do autor. Todos os trechos de texto, figuras, dados de tabela e classificações de trabalho correlato passaram por revisão e validação do autor antes da incorporação ao documento.
